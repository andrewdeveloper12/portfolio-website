      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
              ...
              <div className="space-y-6">
                {contactInfo.map((info, index) => (
                  <motion.div
                    ...
                    className="flex items-start space-x-4 p-4 bg-white rounded-2xl shadow-lg card-hover"
                  >
            ...
            >
              <h4 className="text-xl font-bold mb-4 text-gray-800 flex items-center space-x-2">
