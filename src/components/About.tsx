        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 mb-20">
          ...
          >
            ...
            <div className="bg-white/70 dark:bg-gray-800/50 p-4 rounded-2xl shadow-lg backdrop-blur-sm border border-white/20 mb-2 text-center">
              <div className="absolute -inset-4 bg-gradient-to-r from-yellow-100 to-yellow-200 rounded-3xl blur opacity-25 group-hover:opacity-40 transition duration-1000" />
